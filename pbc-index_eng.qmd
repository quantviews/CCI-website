...
**PBC Commodity Index change to the previous week: [+6.0 p.]{.my-custom-class style="color:#44bf78;"}** ([**+9.4 p.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil: [**+10.1%**]{.my-custom-class style="color:#44bf78;"}, Petroluem Producs: [**+0.1%**]{.my-custom-class style="color:#44bf78;"}
