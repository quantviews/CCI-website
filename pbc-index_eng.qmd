...
**PBC Commodity Index change to the previous week: [+1.2 p.]{.my-custom-class style="color:#44bf78;"}** ([**+27.7 p.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil: [**+1.1%**]{.my-custom-class style="color:#44bf78;"}, Fertilizers Products: [**+0.5%**]{.my-custom-class style="color:#44bf78;"}
