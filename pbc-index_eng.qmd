...
**PBC Commodity Index change to the previous week: [-0.1 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0.5 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**-2.4%**]{.my-custom-class style="color:#f6514c;"}, Pipeline Gaz [**+5.8%**]{.my-custom-class style="color:#44bf78;"}

Over the week the Index has been mainly affected by: Crude Oil [**-0.8 p.**]{.my-custom-class style="color:#f6514c;"}, Pipeline Gaz [**+0.5 p.**]{.my-custom-class style="color:#44bf78;"}
...
February 6, 2025. PBC Commodity price index. **Quotas, tariffs and trade wars will hit the stage in 2025**

[Materials -\>](reports/2025-01 PBC Commodity Index_eng_new.pdf)
