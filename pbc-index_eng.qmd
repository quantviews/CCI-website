...
**PBC Commodity Index change to the previous week: [-1.9 п.]{.my-custom-class style="color:#f6514c;"}** ([**-2.0 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**-3.7%**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**-6.6%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Crude Oil [**-1.2 p.**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**-0.6 p.**]{.my-custom-class style="color:#f6514c;"}
