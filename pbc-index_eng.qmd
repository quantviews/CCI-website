...
**PBC Commodity Index change to the previous week: [-0.6 p.]{.my-custom-class style="color:#f6514c;"}** ([**-0.9 p.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: LNG [**-11%**]{.my-custom-class style="color:#f6514c;"}, Coal [**-1.6%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: LNG [**-0.4 p.**]{.my-custom-class style="color:#f6514c;"}, Coal [**-0.1 p.**]{.my-custom-class style="color:#f6514c;"}
...
September 3, 2025. PBC Commodity price index. **Commodity Price Index dropped in August**

[Materials -\>](reports/2025-08%20PBC%20Commodity%20Index_eng_new.pdf)
