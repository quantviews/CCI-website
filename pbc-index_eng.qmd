...
**PBC Commodity Index change to the previous week: [-1.3 p.]{.my-custom-class style="color:#f6514c;"}** ([**+10.7 p.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil: [**+0.9%**]{.my-custom-class style="color:#44bf78;"}, Petroluem Producs: [**+0.3%**]{.my-custom-class style="color:#44bf78;"}
