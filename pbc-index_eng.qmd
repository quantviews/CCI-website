...
**PBC Commodity Index change to the previous week: [-2.7 п.]{.my-custom-class style="color:#f6514c;"}** ([**-4.6 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**-5.4%**]{.my-custom-class style="color:#f6514c;"}, Coal [**-5.5%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Crude Oil [**-1.6 p.**]{.my-custom-class style="color:#f6514c;"}, Coal [**-0.4 p.**]{.my-custom-class style="color:#f6514c;"}
