...
**PBC Commodity Index** - а composite price index for Russian raw materials that measures price changes of Russian commodity exports comparing to the level of January 2022.
...
index_plot <- highchart() %>% 
   ...
   hc_yAxis_multiples(
      list(title = list(text = "PBC Commodity Index, Jan 2022 = 100"), showFirstLabel = TRUE, max = 180, showLastLabel=TRUE,opposite = FALSE),
...
**PBC Commodity Index changes to the previous week: [+0,2 п.]{.my-custom-class style="color:#44bf78;"}** ([**+2,1 п.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: pipeline gas [**-6,6%**]{.my-custom-class style="color:#f6514c;"}, fertilizers [**+5,1%**]{.my-custom-class style="color:#44bf78;"}

Over the week the Index has been mainly affected by: pipeline gas [**-0,6 п.**]{.my-custom-class style="color:#f6514c;"}, crude oil [**+0,8 п.**]{.my-custom-class style="color:#44bf78;"}
...
factor_plot <- highchart() %>% 
   ...
   hc_add_series(df_factor, hcaes(x = date, y = round(value,2), group = X1), type = 'column', pointWidth = 15, color = colors[1:10]) %>%
...
**Price differential(a discount)** - the difference in price dynamics in Russia's main export commodities compared to the prices of world benchmarks.
...
December 25, 2024. PBC Commodity price index. Commodity index in 2024: **not only the energy sector but...**

[Materials -\>](reports/2024-12-cci-index.pdf)



### [Trending topics]{.my-custom-class style="color:#1a4afc;"}

May 27, 2024. PBC Commodity index: about 

[Materials -\>](events/2024-05-27-PBC-index.qmd)
