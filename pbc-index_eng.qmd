...
**PBC Commodity Index change to the previous week: [-0.6 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0.8 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**+2.1%**]{.my-custom-class style="color:#44bf78;"}, Natural Gaz [**-12%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Crude Oil [**+0.6 p.**]{.my-custom-class style="color:#44bf78;"}, Natural Gaz [**-1.1 p.**]{.my-custom-class style="color:#f6514c;"}
