...
**PBC Commodity Index change to the previous week: [-0.2 p.]{.my-custom-class style="color:#f6514c;"}** ([**-4.5 p.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil: [**+3.4%**]{.my-custom-class style="color:#44bf78;"}, Petroleum Products: [**+0.6%**]{.my-custom-class style="color:#f6514c;"}
...
June 3, 2026. PBC Commodity price index. **Commodity prices turned downward in May**

[Materials -\>](reports/2026-05%20PBC%20Commodity%20Index_eng_new.pdf)
