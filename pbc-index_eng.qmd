...
**PBC Commodity Index change to the previous week: [+1.5 п.]{.my-custom-class style="color:#44bf78;"}** ([**-4.1 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**+4.4%**]{.my-custom-class style="color:#44bf78;"}, Natural Gaz [**+4.1%**]{.my-custom-class style="color:#44bf78;"}

Over the week the Index has been mainly affected by: Crude Oil [**-2.1 p.**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**-1.2 p.**]{.my-custom-class style="color:#f6514c;"}
