...
**PBC Commodity Index change to the previous week: [-0.5 п.]{.my-custom-class style="color:#f6514c;"}** ([**-1.9 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Coal [**+8.0%**]{.my-custom-class style="color:#44bf78;"}, Crude Oil [**-2.7%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Coal [**+0.6 p.**]{.my-custom-class style="color:#44bf78;"}, Crude Oil [**-0.8 p.**]{.my-custom-class style="color:#f6514c;"}
