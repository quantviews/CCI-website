...
**PBC Commodity Index change to the previous week: [-0.7 п.]{.my-custom-class style="color:#f6514c;"}** ([**+0.3 п.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Coal [**+4.3%**]{.my-custom-class style="color:#44bf78;"}, Fertilizers [**-4.4%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Crude Oil [**-0.6 p.**]{.my-custom-class style="color:#f6514c;"}, Pipeline Gaz [**-0.3 p.**]{.my-custom-class style="color:#f6514c;"}
...
df_factor <- subset(df_factor, df_factor$date>'2024-07-01')

df_diff <- df_eng[11,] %>% pivot_longer(-X1, names_to = "date", values_to = 'value')
df_diff$date <- as.Date(df_diff$date)
df_diff <- subset(df_diff, df_diff$date>'2024-07-01')
...
August 6, 2025. PBC Commodity price index. **The second half of 2025 started on a positive note for prices**

[Materials -\>](reports/2025-07%20PBC%20Commodity%20Index_eng_new.pdf)
