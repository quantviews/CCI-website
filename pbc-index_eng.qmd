...
**PBC Commodity Index change to the previous week: [-1.8 п.]{.my-custom-class style="color:#f6514c;"}** ([**+2.3 п.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**-5.8%**]{.my-custom-class style="color:#f6514c;"}, Pipeline Gaz [**+5.4%**]{.my-custom-class style="color:#44bf78;"}

Over the week the Index has been mainly affected by: Crude Oil [**-1.9 п.**]{.my-custom-class style="color:#f6514c;"}, Pipeline Gaz [**+0.5 п.**]{.my-custom-class style="color:#44bf78;"}
