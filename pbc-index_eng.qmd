...
**PBC Commodity Index change to the previous week: [+0.1 п.]{.my-custom-class style="color:#44bf78;"}** ([**-5.1 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Fertilizers [**-3.9%**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**+3.3%**]{.my-custom-class style="color:#44bf78;"}

Over the week the Index has been mainly affected by: Fertilizers [**-0.1 p.**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**+0.3 p.**]{.my-custom-class style="color:#44bf78;"}
...
March 5, 2025. PBC Commodity price index. **Export prices are bak to initial position**

[Materials -\>](reports/2025-02 PBC Commodity Index_eng.pdf)
