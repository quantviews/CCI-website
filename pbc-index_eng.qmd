...
**PBC Commodity Index change to the previous week: [+0.1 p.]{.my-custom-class style="color:#44bf78;"}** ([**+8.7 p.**]{.my-custom-class style="color:#44bf78;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil: [**-4.9%**]{.my-custom-class style="color:#f6514c;"}, Natural Gas: [**+2.5%**]{.my-custom-class style="color:#44bf78;"}
