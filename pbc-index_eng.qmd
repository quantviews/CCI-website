...
**PBC Commodity Index change to the previous week: [-5.9 п.]{.my-custom-class style="color:#f6514c;"}** ([**-4.9 п.**]{.my-custom-class style="color:#f6514c;"} over the previous four weeks)

The biggest commodity price changes over the week: Crude Oil [**-14%**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**-13%**]{.my-custom-class style="color:#f6514c;"}

Over the week the Index has been mainly affected by: Crude Oil [**-4.3 p.**]{.my-custom-class style="color:#f6514c;"}, Natural Gaz [**-1.1 p.**]{.my-custom-class style="color:#f6514c;"}
