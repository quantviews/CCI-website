...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [-0,6 п.]{.my-custom-class style="color:#f6514c;"}** ([**-2,3 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: трубопроводный газ [**+8,6%**]{.my-custom-class style="color:#44bf78;"}, нефть [**-3,9%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: трубопроводный газ [**+0,8 п.**]{.my-custom-class style="color:#44bf78;"}, нефть [**-1,2 п.**]{.my-custom-class style="color:#f6514c;"}
