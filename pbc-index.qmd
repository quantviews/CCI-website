...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-0,6 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0,8 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**+2,1%**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**-12%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**+0,6 п.**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**-1,1 п.**]{.my-custom-class style="color:#f6514c;"}
