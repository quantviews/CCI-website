...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-2,7 п.]{.my-custom-class style="color:#f6514c;"}** ([**-4,6 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**-5,4%**]{.my-custom-class style="color:#f6514c;"}, уголь [**-5,5%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-1,6 п.**]{.my-custom-class style="color:#f6514c;"}, уголь [**-0,4 п.**]{.my-custom-class style="color:#f6514c;"}
