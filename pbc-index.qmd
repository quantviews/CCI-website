...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+1,5 п.]{.my-custom-class style="color:#44bf78;"}** ([**-4,1 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефтm [**+4,4%**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**+4,1%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-2,1 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-1,2 п.**]{.my-custom-class style="color:#f6514c;"}
