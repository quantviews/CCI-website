...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [-1,3 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0,9 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: подсолнечное масло [**+11%**]{.my-custom-class style="color:#44bf78;"}, нефть [**-3,1%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: подсолнечное масло [**+0,3 п.**]{.my-custom-class style="color:#44bf78;"}, нефть [**-1,0 п.**]{.my-custom-class style="color:#f6514c;"}
