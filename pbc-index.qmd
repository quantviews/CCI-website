...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-0,2 п.]{.my-custom-class style="color:#f6514c;"}** ([**-4,5 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: Нефть [**+3,4%**]{.my-custom-class style="color:#44bf78;"}, Нефтепродукты: [**+0,6%**]{.my-custom-class style="color:#44bf78;"}
