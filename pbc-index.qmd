...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [+1,2 п.]{.my-custom-class style="color:#44bf78;"}** ([**-2,8 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**+4,1%**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**-2,9%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**+1,3 п.**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**-0,2 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Мониторинг - Август 2024](reports/2024-08-cci-index.pdf)
