...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [0,0 п.]{.my-custom-class style="color:44bf78;"}** ([**-4,8 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**+0,8%**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**-1,7%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-3,0 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-1,2 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Материалы -\>](reports/2025-03%20Сырьевой%20индекс%20ЦЦИ.pdf)
