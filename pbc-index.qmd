...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+6,0 п.]{.my-custom-class style="color:#44bf78;"}** ([**+9,4 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: Нефть [**+10,1%**]{.my-custom-class style="color:#44bf78;"}, Нефтепродукты: [**+0,1%**]{.my-custom-class style="color:#44bf78;"}
