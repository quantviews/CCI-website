...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-0,6 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0,9 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: СПГ [**-11%**]{.my-custom-class style="color:#f6514c;"}, уголь [**-1,6%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: СПГ [**-0,4 п.**]{.my-custom-class style="color:#f6514c;"}, уголь [**-0,1 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Материалы -\>](reports/2025-08%20Сырьевой%20индекс%20ЦЦИ.pdf)
