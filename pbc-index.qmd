...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+0,1 п.]{.my-custom-class style="color:#44bf78;"}** ([**+8,7 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: Нефть [**-4,9%**]{.my-custom-class style="color:#f6514c;"}, Газ: [**+2,3%**]{.my-custom-class style="color:#44bf78;"}
