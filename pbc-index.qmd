...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [-0,3 п.]{.my-custom-class style="color:#f6514c;"}** ([**-1,5 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: трубопроводный газ [**-4,7%**]{.my-custom-class style="color:#f6514c;"}, уголь [**-4,3%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: трубопроводный газ [**-0,4 п.**]{.my-custom-class style="color:#f6514c;"}, уголь [**-0,3 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Мониторинг - Декабрь 2024](reports/2024-12-cci-index.pdf)
