...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+3,0 п.]{.my-custom-class style="color:#44bf78;"}** ([**+7,8 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: Нефть [**-1,2%**]{.my-custom-class style="color:#f6514c;"}, Металлы: [**+0,5%**]{.my-custom-class style="color:#44bf78;"}
