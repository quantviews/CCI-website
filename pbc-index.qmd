...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [+2,2 п.]{.my-custom-class style="color:#44bf78;"}** ([**+4,6 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефтепродукты [**+7,1%**]{.my-custom-class style="color:#44bf78;"}, удобрения [**+5,2%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**+1,3 п.**]{.my-custom-class style="color:#44bf78;"}, нефтепродукты [**+0,3 п.**]{.my-custom-class style="color:#44bf78;"}
