...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-0,1 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0,5 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**-2,4%**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**+5,8%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-0,8 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**+0,5 п.**]{.my-custom-class style="color:#44bf78;"}
...
[Материалы -\>](reports/2025-01 Сырьевой индекс ЦЦИ.pdf)
