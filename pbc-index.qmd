...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+6,2 п.]{.my-custom-class style="color:#44bf78;"}** ([**+27 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: Нефть [**+23,2%**]{.my-custom-class style="color:#44bf78;"}, Нефтепродукты: [**+3,6%**]{.my-custom-class style="color:#44bf78;"}
