...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [+1,8 п.]{.my-custom-class style="color:#44bf78;"}** ([**+1,7 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: подсолнечное масло [**+6,5%**]{.my-custom-class style="color:#44bf78;"}, трубопроводный газ [**+5,3%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: трубопроводный газ [**+0,6 п.**]{.my-custom-class style="color:#44bf78;"}, нефть [**+0,5 п.**]{.my-custom-class style="color:#44bf78;"}
