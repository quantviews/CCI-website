...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-5,9 п.]{.my-custom-class style="color:#f6514c;"}** ([**-4,9 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефтm [**-14%**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-13%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-4,3 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-1,1 п.**]{.my-custom-class style="color:#f6514c;"}
