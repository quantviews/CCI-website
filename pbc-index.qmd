...
index_plot <- highchart() %>% 
   ...
   hc_yAxis_multiples(
      list(title = list(text = "Индекс сырьевых цен ЦЦИ, янв. 2022 = 100"), showFirstLabel = TRUE, max = 160, showLastLabel=TRUE,opposite = FALSE),
...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [-0,7 п.]{.my-custom-class style="color:#f6514c;"}** ([**-0,4 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: трубопроводный газ [**+6,6%**]{.my-custom-class style="color:#44bf78;"}, удобрения [**-4,6%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: трубопроводный газ [**+0,6 п.**]{.my-custom-class style="color:#44bf78;"}, нефть [**-1,1 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Мониторинг - Октябрь 2024](reports/2024-10-cci-index.pdf)
