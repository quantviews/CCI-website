...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-1,9 п.]{.my-custom-class style="color:#f6514c;"}** ([**-2,0 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**-3,7%**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-6,6%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-1,2 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-0,6 п.**]{.my-custom-class style="color:#f6514c;"}
