...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [+0,2 п.]{.my-custom-class style="color:#44bf78;"}** ([**+2,1 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: трубопроводный газ [**-6,6%**]{.my-custom-class style="color:#f6514c;"}, удобрения [**+5,1%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: трубопроводный газ [**-0,6 п.**]{.my-custom-class style="color:#f6514c;"}, нефть [**+0,8 п.**]{.my-custom-class style="color:#44bf78;"}
