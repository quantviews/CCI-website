...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [+0,1 п.]{.my-custom-class style="color:#44bf78;"}** ([**-5,1 п.**]{.my-custom-class style="color:#f6514c;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: удобрения [**-3,9%**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**+3,3%**]{.my-custom-class style="color:#44bf78;"}

Наибольшие вклады в изменение Индекса за неделю: удобрения [**-0,1 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**+0,3 п.**]{.my-custom-class style="color:#44bf78;"}
...
[Материалы -\>](reports/2025-02 Сырьевой индекс ЦЦИ.pdf)
