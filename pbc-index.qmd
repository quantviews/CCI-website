...
**Изменение Индекса сырьевых цен ЦЦИ к предыдущей неделе: [-1,9 п.]{.my-custom-class style="color:#f6514c;"}** ([**+2,1 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: нефть [**-4,7%**]{.my-custom-class style="color:#f6514c;"}, нефтепродукты [**-6,7%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-1,7 п.**]{.my-custom-class style="color:#f6514c;"}, нефтепродукты [**-0,3 п.**]{.my-custom-class style="color:#f6514c;"}
