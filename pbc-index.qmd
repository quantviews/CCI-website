...
**Изменение Сырьевого индекса ЦЦИ к предыдущей неделе: [-0,7 п.]{.my-custom-class style="color:#f6514c;"}** ([**+0,3 п.**]{.my-custom-class style="color:#44bf78;"} за последние 4 недели)

Наибольшие изменения цен товаров за неделю: уголь [**+4,3%**]{.my-custom-class style="color:#44bf78;"}, удобрения [**-4,4%**]{.my-custom-class style="color:#f6514c;"}

Наибольшие вклады в изменение Индекса за неделю: нефть [**-0,6 п.**]{.my-custom-class style="color:#f6514c;"}, трубопроводный газ [**-0,3 п.**]{.my-custom-class style="color:#f6514c;"}
...
[Материалы -\>](reports/2025-07%20Сырьевой%20индекс%20ЦЦИ.pdf)
