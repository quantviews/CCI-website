...
Консенсус-прогноз по росту арендных ставок на складском рынке московского региона на 2026 г. пересмотрен в сторону снижения и оказался в отрицательной зоне, на 2027 г. – оставлен без изменений. Прогнозы по доле свободных складских площадей на 2026 г. пересмотрены вверх всеми участниками опроса.

Консенсус-прогноз по доле свободных офисов класса A в Москве существенно пересмотрен вверх. Это связано как с охлаждением деловой активности, так и с ожидаемым ростом ввода в эксплуатацию бизнес-центров, строящихся жилищными застройщиками по программе создания мест приложения труда.
:::
...
hc <- highchart() %>% 
   ...
   hc_yAxis(title  = list(text = '%'), max = 6, min = 1) %>% 
