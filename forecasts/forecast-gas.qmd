...
Несмотря на ввод в эксплуатацию в конце декабря 2025 г. газовоза ледового класса «Алексей Косыгин», аналитики снизили ожидания по экспорту российского СПГ в 2026–2027 гг.

Холодная погода и высокие темпы отбора газа из подземных хранилищ в ЕС текущей зимой стали причиной пересмотра вверх консенсус-прогноза по цене на газ TTF в 2026 г.

Аналитики пересмотрели вниз прогноз по глобальному индексу на СПГ с нефтяной привязкой в 2026–2027 гг. в связи с ожидаемым падением цен на нефть.
:::
...
hc <- highchart() %>% 
   ...
   hc_yAxis(title  = list(text = 'долл. млн/БТЕ'), max = 4.5, min = 3) %>% 
...
[Спецификация консенсуса](../pdf/Gas%20Consensus%20Methodology%20PBC.pdf)
:::
::::
:::::::::::
