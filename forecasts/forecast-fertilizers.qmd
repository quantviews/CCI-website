...
::: {.g-col-12 .g-col-sm-12 .g-col-xs-12 .g-col-xl-10 .g-col-md-6 .g-col-lg-6}
## Результаты опроса: август 2024 г.
...
Экспертами были пересмотрены цены на карбамид в конце 2024 (+3%) и 2025 (+4%) г. относительно прошлого консенсуса. Причиной является пересмотр цен на природный газ в сторону увеличения, который может быть связан с увеличением потребления природного газа в странах Азии по причине аномальной жары.

Прогноз производства и экспорта хлористого калия на 2024 и 2025 г. был пересмотрен аналитиками в сторону увеличения. Производство в 2024 и 2025 г согласно прогнозу вырастет на 6 и 7% соответственно, экспорт на 25 и 23 %. Это связано с планами Уралхима и Еврохима по увеличению своих калийных мощностей. Прогноз увеличения экспорта связан с наращиванием присутствия компаний в Китае, Индии и Бразилии.

В связи с увеличением экспортного предложения хлорида калия на мировом рынке, аналитики пересмотрели уровень цен на хлористый калий в 2024 (-6%) и 2025 г (-4%).
:::
...
hc <- highchart() %>% 
   ...
   hc_yAxis(title  = list(text = 'долл./т'), max = 450, min = 200) %>% 
...
В опросе приняли участие 5 профессиональных аналитиков, 3 из них дали согласие на раскрытие информации об их участии в опросе:

| <!-- --> | <!-- --> | <!-- --> |
|------------------------|--------------------------|----------------------|
| Адамова Нина (Газпромбанк) | Лебедской-Тамбиев Артем (Аналитический центр ТЭК) | Попова Евгения (Имплемента) |
