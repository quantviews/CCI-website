...
#### Разница цен на растительные масла в начале октября 2024, долл./т
...
df = pivot_longer(df, -1, names_to = "id")
names(df)[1] = 'type'

hc = highchart() %>%
   hc_add_series(df, type = "column", hcaes(x = id, y = value, group = type), color = c("#1A4AFC", "#FF7900"), stacking = "normal") %>%
