...
Геополитическая напряжённость на Ближнем Востоке разворачивает динамику цен на метанол.

![](../images/icon-locker.svg){width="6%"} [Подробнее](../demo-subscription.qmd)

*11.06.2025 Метанол*

**Цены на метанол стремятся к минимумам 2023 г.**

Индекс цен российских производителей метанола снижается в июне на 7%.

![](../images/icon-locker.svg){width="6%"} [Подробнее](../demo-subscription.qmd)

*26.05.2025 Каустическая сода*

**Сода нащупала баланс, но надолго ли?**

В мае индексы цен на каустическую соду на внутреннем рынке остались без изменений.
